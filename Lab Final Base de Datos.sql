...
/*
		Nombre:		Jesus Eduardo Alvarado Ramos
		Matricula:	1726329

		Descripcion:
			 Aplicacion web que apoye principalmente a alumnos de la Facultad en la seleccion de maestros.
*/


USE [Comunidad_FCFM_By_Eduardo]
GO
...
GO
/****** Object:  View [dbo].[VIEW_Materias]    Script Date: 26/10/2018 18:55:45 ******/
DROP VIEW [dbo].[VIEW_Materias]
GO
/****** Object:  View [dbo].[VIEW_Maestro_Materias]    Script Date: 26/10/2018 18:55:45 ******/
DROP VIEW [dbo].[VIEW_Maestro_Materias]
GO
/****** Object:  View [dbo].[VIEW_TotalDeMaestrosPorCarrera]    Script Date: 26/10/2018 18:55:45 ******/
DROP VIEW [dbo].[VIEW_TotalDeMaestrosPorCarrera]
GO
/****** Object:  View [dbo].[VIEW_Maestros]    Script Date: 26/10/2018 18:55:45 ******/
DROP VIEW [dbo].[VIEW_Maestros]
GO
/****** Object:  View [dbo].[VIEW_PromeidoTotal_Maestro]    Script Date: 26/10/2018 18:55:45 ******/
DROP VIEW [dbo].[VIEW_PromeidoTotal_Maestro]
GO
/****** Object:  View [dbo].[VIEW_AllComentarios]    Script Date: 26/10/2018 18:55:45 ******/
DROP VIEW [dbo].[VIEW_AllComentarios]
GO
/****** Object:  View [dbo].[VIEW_Calificaciones]    Script Date: 26/10/2018 18:55:45 ******/
DROP VIEW [dbo].[VIEW_Calificaciones]
GO
/****** Object:  View [dbo].[VIEW_Clases]    Script Date: 26/10/2018 18:55:45 ******/
DROP VIEW [dbo].[VIEW_Clases]
GO
/****** Object:  Table [dbo].[Rel_Materia_Maestro]    Script Date: 26/10/2018 18:55:45 ******/
DROP TABLE [dbo].[Rel_Materia_Maestro]
GO
/****** Object:  Table [dbo].[Materia]    Script Date: 26/10/2018 18:55:45 ******/
DROP TABLE [dbo].[Materia]
GO
/****** Object:  Table [dbo].[Maestro]    Script Date: 26/10/2018 18:55:45 ******/
DROP TABLE [dbo].[Maestro]
GO
/****** Object:  Table [dbo].[Carrera]    Script Date: 26/10/2018 18:55:45 ******/
DROP TABLE [dbo].[Carrera]
GO
/****** Object:  Table [dbo].[Calificacion]    Script Date: 26/10/2018 18:55:45 ******/
DROP TABLE [dbo].[Calificacion]
GO
/****** Object:  UserDefinedFunction [dbo].[FN_PromDeDosCalificaciones]    Script Date: 26/10/2018 18:55:45 ******/
DROP FUNCTION [dbo].[FN_PromDeDosCalificaciones]
GO
/****** Object:  StoredProcedure [dbo].[SP_BuscarMateria]    Script Date: 26/10/2018 18:55:45 ******/
DROP PROCEDURE [dbo].[SP_BuscarMateria]
GO
/****** Object:  StoredProcedure [dbo].[SP_BuscarMaestro]    Script Date: 26/10/2018 18:55:45 ******/
DROP PROCEDURE [dbo].[SP_BuscarMaestro]
GO
/****** Object:  StoredProcedure [dbo].[SP_BuscarEnComentarios]    Script Date: 26/10/2018 18:55:45 ******/
DROP PROCEDURE [dbo].[SP_BuscarEnComentarios]
GO
/****** Object:  StoredProcedure [dbo].[SP_Add_Materia]    Script Date: 26/10/2018 18:55:45 ******/
DROP PROCEDURE [dbo].[SP_Add_Materia]
GO
/****** Object:  StoredProcedure [dbo].[SP_Add_Maestro]    Script Date: 26/10/2018 18:55:45 ******/
DROP PROCEDURE [dbo].[SP_Add_Maestro]
GO
/****** Object:  StoredProcedure [dbo].[SP_Add_Clase]    Script Date: 26/10/2018 18:55:45 ******/
DROP PROCEDURE [dbo].[SP_Add_Clase]
GO
/****** Object:  StoredProcedure [dbo].[SP_Add_Carrera]    Script Date: 26/10/2018 18:55:45 ******/
DROP PROCEDURE [dbo].[SP_Add_Carrera]
GO
USE [master]
GO
/****** Object:  Database [Comunidad_FCFM_By_Eduardo]    Script Date: 26/10/2018 18:55:45 ******/
DROP DATABASE [Comunidad_FCFM_By_Eduardo]
GO
/****** Object:  Database [Comunidad_FCFM_By_Eduardo]    Script Date: 26/10/2018 18:55:45 ******/
CREATE DATABASE [Comunidad_FCFM_By_Eduardo]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'Comunidad_FCFM_By_Eduardo', FILENAME = N'c:\Program Files\Microsoft SQL Server\MSSQL11.MSSQLSERVER\MSSQL\DATA\Comunidad_FCFM_By_Eduardo.mdf' , SIZE = 4160KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'Comunidad_FCFM_By_Eduardo_log', FILENAME = N'c:\Program Files\Microsoft SQL Server\MSSQL11.MSSQLSERVER\MSSQL\DATA\Comunidad_FCFM_By_Eduardo_log.ldf' , SIZE = 1040KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO
ALTER DATABASE [Comunidad_FCFM_By_Eduardo] SET COMPATIBILITY_LEVEL = 110
GO
IF (1 = FULLTEXTSERVICEPROPERTY('IsFullTextInstalled'))
begin
EXEC [Comunidad_FCFM_By_Eduardo].[dbo].[sp_fulltext_database] @action = 'enable'
end
GO
ALTER DATABASE [Comunidad_FCFM_By_Eduardo] SET ANSI_NULL_DEFAULT OFF 
GO
ALTER DATABASE [Comunidad_FCFM_By_Eduardo] SET ANSI_NULLS OFF 
GO
ALTER DATABASE [Comunidad_FCFM_By_Eduardo] SET ANSI_PADDING OFF 
GO
ALTER DATABASE [Comunidad_FCFM_By_Eduardo] SET ANSI_WARNINGS OFF 
GO
ALTER DATABASE [Comunidad_FCFM_By_Eduardo] SET ARITHABORT OFF 
GO
ALTER DATABASE [Comunidad_FCFM_By_Eduardo] SET AUTO_CLOSE ON 
GO
ALTER DATABASE [Comunidad_FCFM_By_Eduardo] SET AUTO_CREATE_STATISTICS ON 
GO
ALTER DATABASE [Comunidad_FCFM_By_Eduardo] SET AUTO_SHRINK OFF 
GO
ALTER DATABASE [Comunidad_FCFM_By_Eduardo] SET AUTO_UPDATE_STATISTICS ON 
GO
ALTER DATABASE [Comunidad_FCFM_By_Eduardo] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO
ALTER DATABASE [Comunidad_FCFM_By_Eduardo] SET CURSOR_DEFAULT  GLOBAL 
GO
ALTER DATABASE [Comunidad_FCFM_By_Eduardo] SET CONCAT_NULL_YIELDS_NULL OFF 
GO
ALTER DATABASE [Comunidad_FCFM_By_Eduardo] SET NUMERIC_ROUNDABORT OFF 
GO
ALTER DATABASE [Comunidad_FCFM_By_Eduardo] SET QUOTED_IDENTIFIER OFF 
GO
ALTER DATABASE [Comunidad_FCFM_By_Eduardo] SET RECURSIVE_TRIGGERS OFF 
GO
ALTER DATABASE [Comunidad_FCFM_By_Eduardo] SET  ENABLE_BROKER 
GO
ALTER DATABASE [Comunidad_FCFM_By_Eduardo] SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO
ALTER DATABASE [Comunidad_FCFM_By_Eduardo] SET DATE_CORRELATION_OPTIMIZATION OFF 
GO
ALTER DATABASE [Comunidad_FCFM_By_Eduardo] SET TRUSTWORTHY OFF 
GO
ALTER DATABASE [Comunidad_FCFM_By_Eduardo] SET ALLOW_SNAPSHOT_ISOLATION OFF 
GO
ALTER DATABASE [Comunidad_FCFM_By_Eduardo] SET PARAMETERIZATION SIMPLE 
GO
ALTER DATABASE [Comunidad_FCFM_By_Eduardo] SET READ_COMMITTED_SNAPSHOT OFF 
GO
ALTER DATABASE [Comunidad_FCFM_By_Eduardo] SET HONOR_BROKER_PRIORITY OFF 
GO
ALTER DATABASE [Comunidad_FCFM_By_Eduardo] SET RECOVERY SIMPLE 
GO
ALTER DATABASE [Comunidad_FCFM_By_Eduardo] SET  MULTI_USER 
GO
ALTER DATABASE [Comunidad_FCFM_By_Eduardo] SET PAGE_VERIFY CHECKSUM  
GO
ALTER DATABASE [Comunidad_FCFM_By_Eduardo] SET DB_CHAINING OFF 
GO
ALTER DATABASE [Comunidad_FCFM_By_Eduardo] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO
ALTER DATABASE [Comunidad_FCFM_By_Eduardo] SET TARGET_RECOVERY_TIME = 0 SECONDS 
GO
USE [Comunidad_FCFM_By_Eduardo]
GO
/****** Object:  StoredProcedure [dbo].[SP_Add_Carrera]    Script Date: 26/10/2018 18:55:45 ******/
...
USE [master]
GO
ALTER DATABASE [Comunidad_FCFM_By_Eduardo] SET  READ_WRITE 
GO
